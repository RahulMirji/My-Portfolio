...
if (isset($_POST['send'])) {
    ...
    $first_name = mysqli_real_escape_string($conn, $_POST['user_name']);
    $user_email = mysqli_real_escape_string($conn, $_POST['user_email']);
    $message = mysqli_real_escape_string($conn, $_POST['message']);

    // Insert data into the database
    $insert_query = "INSERT INTO contact_me (user_name, user_email, message) VALUES ('$first_name', '$user_email', '$message')";
